...
# df = pd.read_csv('/Users/fanyue/Downloads/Chun_Batch_4666027_batch_results.csv')
...
#             else:
#
#                 print ("\nAutomatic Answer: Nope, you haven't get there.\n")
#
#                 approve = 'Poor quality, the pilot failed to find the right destination using your instruction. '
#                 your_input = ''
#
#
#
